...
public class Ventana_Información_Centro extends javax.swing.JFrame {

    Centro CentroAux;
    
    public Ventana_Información_Centro(Centro CentroAux1) {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        this.CentroAux=CentroAux1;
        try
        {
        
        BuscarNombreCentroTF.setText(CentroAux.getNomC());
        BuscarNumeroCentroTF.setText(CentroAux.getNumero());
        BuscarDireccionCentroTF.setText(CentroAux.getDireccion());
        BuscarLatitudCentroTF.setText(Double.toString(CentroAux.getLatitud()));  
        BuscarLongitudCentroTF.setText(Double.toString(CentroAux.getLongitud()));
        DistanciaTF.setText(Double.toString(CentroAux.getDistancia()));
        }
        catch   (Exception e)
                {
                    System.out.println("error al ver centro");
                }
    }

    private Ventana_Información_Centro() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(BuscarLatitudCentroTF, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_Información_Centro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_Información_Centro().setVisible(true);
            }
        });
    }
